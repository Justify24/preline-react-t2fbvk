export default function ScrollSpy() {
  return (
    ...
    >
      <header className="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-40 w-full bg-white text-sm py-4">
        <nav
        ...
        >
          ...
          >
            ...
            >
              <a
                className="text-sm text-gray-700 leading-6 hover:text-gray-500 active"
                href="#first"
              >
                First
              </a>
              <a
                className="text-sm text-gray-700 leading-6 hover:text-gray-500"
                href="#second"
              >
                Second
              </a>
              ...
              >
                <a
                  ...
                  className="group hs-scrollspy-active:text-blue-600 mb-3 sm:mb-0 inline-flex justify-center items-center gap-2 text-sm text-gray-700 leading-6 hover:text-gray-500"
                  href="javascript:;"
                >
                  Dropdown
                  <svg
